...
async function getBlogPosts(): Promise<BlogPost[]> {
  ...
  // 👇 Cast query to any so TypeScript doesn’t complain about "order"
  const res: any = await client.getEntries({
    content_type: 'blogPost',
    order: ['-fields.date'], // array is safer + removes red underline
  } as any);
    ...
    <section className="container mx-auto px-6 py-20">
      <div className="text-center mb-16">
        ...
        <p className="mt-4 text-gray-400">
          Stay updated with our latest insights on AI, technology, and business
          innovation.
        </p>
      </div>
